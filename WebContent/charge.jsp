...
<p>充值金额 ：
<input type="text" name="money" style="border:0;outline:0;font-weight:bold;font-size:40px;height:50px;width:55%;text-align:right;">
...
<input type="submit" value="充值" style="font-size:40px;height:100px;width:90%;background:rgb(255,128,0);color:white">
</div>
</form>
